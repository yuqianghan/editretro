...
@register_criterion("pretrain_nat_loss")
class LabelSmoothedDualImitationCriterion_MLM(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        outputs = model(src_tokens=src_tokens,
        ...
        nll_loss = sum(
            l for l in nll_loss) if len(nll_loss) > 0 else loss.new_tensor(0)
