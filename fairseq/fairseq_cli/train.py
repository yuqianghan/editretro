...
def train(args, trainer, task, epoch_itr):
    ...
    update_freq = (args.update_freq[epoch_itr.epoch - 1] if epoch_itr.epoch
                   <= len(args.update_freq) else args.update_freq[-1])
    ...
    for samples in progress:
        ...
        if (not args.disable_validation and args.save_interval_updates > 0
            ...
            # SARI_validate(args, trainer, task, epoch_itr)
            checkpoint_utils.save_checkpoint(args, trainer, epoch_itr,
                                             valid_losses[0])
