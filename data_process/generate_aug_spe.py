# The code is modified from https://github.com/otori-bird/retrosynthesis/blob/main/preprocessing/generate_PtoR_data.py
...
if __name__ == '__main__':
    ...
    if args.dataset == "USPTO-MIT":
        datadir = './raw_datasets/{}'.format(args.dataset)
        savedir = '.processed_datasets/{}_aug{}'.format(
