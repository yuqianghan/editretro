...
pretrain_ckpt_path=$root_dir/exp_pretrain/checkpoints1 # pretrain checkpoint path

python EditRetro/utils/average_checkpoints.py --inputs $pretrain_ckpt_path \
    --output $pretrain_ckpt_path/avg.pt \
    --num-epoch-checkpoints 20

python EditRetro/utils/pretrain_ckpt_utils.py \
